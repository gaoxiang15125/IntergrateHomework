...
public class CatEyePo {
     ...
     *不实例化用户评论的构造方法
     */
    public CatEyePo(ImageIcon movie_Pic, String movie_Name, String movie_English_Name, String types, String shoot_Place, double lasting_Time, Date show_Time, String show_Place, double user_Score, double user_NUM, double booking_Office, String introduction) {
     ...
     *实例化用户评价信息的构造方法
     */
    public CatEyePo(ImageIcon movie_Pic, String movie_Name, String movie_English_Name, String types, String shoot_Place, double lasting_Time, Date show_Time, String show_Place, double user_Score, double user_NUM, double booking_Office, String introduction, Vector<CatReviewPo> catReviewPoVector) {
        this.movie_Pic = movie_Pic;
        this.movie_Name = movie_Name;
        this.movie_English_Name = movie_English_Name;
        this.types = types;
